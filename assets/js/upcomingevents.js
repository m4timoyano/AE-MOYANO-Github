...
function armarCard(eventsarray, container) {
    for (let nuevacard of eventsarray) {
        if (currentDate < nuevacard.date) {
            let div = document.createElement("div")
            div.className = "col"
            div.innerHTML += `<div class="card h-100">
                <img src="${nuevacard.image}" class="card-img-top h-50"
                alt="...">
                <div class="card-body">
                    ...
                    <p style="display: inline;">$ ${nuevacard.price}</p>
